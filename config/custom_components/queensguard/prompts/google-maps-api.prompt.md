...
3. Create service.py for calling google maps services. These services should use the googlemaps python package.
    #fetch the docs at https://googlemaps.github.io/google-maps-services-python/docs/index.html